...
test('serialize messages of all types and parse them again', () => {
  const messages: readonly Message[] = [
    {messageType: MessageType.MethodCall, path: '/', member: 'foo', serial: 42},
    {messageType: MessageType.MethodCall, path: '/', member: 'foo', serial: 42, noReplyExpected: true},
    {messageType: MessageType.MethodCall, path: '/', member: 'foo', serial: 42, noAutoStart: true},
    {messageType: MessageType.MethodCall, path: '/', member: 'foo', serial: 42, allowInteractiveAuthorization: true},
    {
      messageType: MessageType.MethodCall,
      path: '/',
      interface: 'foo',
    ...
    {messageType: MessageType.Signal, path: '/', interface: 'foo', member: 'bar', serial: 42},
    {
      messageType: MessageType.Signal,
      path: '/',
      interface: 'foo',
